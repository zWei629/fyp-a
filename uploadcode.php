...
<head>
    <title>O.W Skincare : Upload Report</title>
...
<body>
    ...
    echo "file orig name is ".$file_o_name.'<br>';*/
        if ($file_type == "application/pdf") {
            ...
            if ($upload) {
                #save data
                $saveData = mysqli_query($con, "UPDATE doctor_appointment SET Report='$server_path' WHERE Id='$id' ") or die(mysqli_error($con));
                if ($saveData) {
                    echo '
                <script>
