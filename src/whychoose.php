                        ...
                        <div class="whyChoose-left">
                            <div class="whychoose-slider">
                                <div class="whychoose-singleslide">
                                    <img src="images/whychoose1.jpg" alt="img">
                                </div>
                                <div class="whychoose-singleslide">
                                    <img src="images/whychoose2.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="whyChoose-right">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>The best in skincare equipments providing the best results.</p>
                                </div>
                            </div>
                            <div class="media">
                                <div class="media-left">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">Deliver Real Result</h4>
                                    <p>Providing fast and real result and catering to our patients need.</p>
                                </div>
                            </div>
                        </div>
                    </div>
